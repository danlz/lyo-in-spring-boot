...
<html lang="en">
  <head>
    ...
    <title>Service Provider Catalog - OSLC Server1 OSLC Adapter</title>
  ...
  <div class="container">
    <div class="page-header">
      <h1>OSLC Server1 Service Provider Catalogue</h1>
    </div>
    ...
    <% if (catalog.getServiceProviders().length == 0) {%>
        <div class="alert alert-primary" role="alert">
            ...
            <p>
                ...
                in the class <code>com.danlz.spring.boot.lyo.generated.RestDelegate</code>, to return the expected set of Service Provider resources.
            </p>
        </div>
    <% } %>
